...
export const getUsers = async (req, res) => {
  try {
    ...
    if (req.websiteId) {
      ...
      const websiteIdObj = req.websiteId instanceof mongoose.Types.ObjectId 
        ? req.websiteId 
        : (mongoose.Types.ObjectId.isValid(req.websiteId) ? new mongoose.Types.ObjectId(req.websiteId) : req.websiteId);
