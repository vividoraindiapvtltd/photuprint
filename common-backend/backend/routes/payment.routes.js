...
import { resolveTenant, requireTenant, skipTenant } from "../middlewares/tenant.middleware.js"

const router = express.Router()

// Public: Get Razorpay key for frontend (resolves website from header to return per-website key)
router.get("/razorpay-key", skipTenant, getRazorpayKey)
